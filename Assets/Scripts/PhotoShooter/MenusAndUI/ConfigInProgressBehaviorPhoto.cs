...
public class ConfigInProgressBehaviorPhoto : MonoBehaviour
{
    ...
    private void FixedUpdate() {
        switch (currentStep) {
            ...
            case ConfigStep.LeaveMenu:
                ...
                currentStep = ConfigStep.WaitToConfig;
                continueText.text = "Start";
                mainMenu.TryGetComponent<MainMenuBehaviorPhoto>(out MainMenuBehaviorPhoto mainMenuBehaviorPhoto);
                mainMenuBehaviorPhoto.SetFirstTimeFalse();
                gameObject.SetActive(false);
                break;
        }
        if (isProcessing) {
